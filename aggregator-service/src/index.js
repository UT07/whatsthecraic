...
app.post('/v1/auth/spotify/connect', (req, res) => proxyRequest(req, res, { url: `${AUTH_SERVICE_URL}/auth/spotify/connect`, method: 'post' }));
...
app.delete('/v1/auth/youtube/disconnect', (req, res) => proxyRequest(req, res, { url: `${AUTH_SERVICE_URL}/auth/youtube/disconnect`, method: 'delete' }));
